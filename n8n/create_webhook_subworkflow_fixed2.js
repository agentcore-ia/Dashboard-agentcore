...
async function main() {
  ...
  const gSheetsTool = mainWf.nodes.find(n => n.name === 'Orden' && (n.type === 'n8n-nodes-base.googleSheetsTool' || n.type === 'n8n-nodes-langchain.toolHttpRequest'));
  ...
  // Activate webhook
  await apiCall('POST', `/workflows/${createSubWfRes.id}/activate`);
