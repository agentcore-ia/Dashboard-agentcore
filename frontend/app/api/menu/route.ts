...
const SERVICE_EMAIL = 'dashboard@agent-core-490803.iam.gserviceaccount.com';
...
export async function POST(request: NextRequest) {
    try {
        ...
        const price = parseFloat(String(data.precio).replace(/[^0-9.]/g, ''));
