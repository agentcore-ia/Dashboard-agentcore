      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <div className="flex items-center gap-1.5 text-stone-400 mt-1">
            <span className="material-symbols-outlined text-sm">{order.customer_phone ? 'chat' : 'storefront'}</span>
            <span className="text-xs font-semibold flex items-center gap-2">
              {pickup ? 'Retiro' : 'Delivery'} • {order.customer_phone ? 'WhatsApp' : 'Local'} • #{order.order_number}
